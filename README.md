<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Optic%20X%20Camera%20Ecosystem&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Optic X Camera Ecosystem Header Banner" />

  <h1>🚀 Optic X Camera Ecosystem</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/optic_x_camera_ecosystem"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Optic X Camera Ecosystem** delivers a fast, responsive, and cross-platform browser experience built with **HTML** and hardware-accelerated canvas rendering.
...
```bash
git clone https://github.com/hsinidev/optic_x_camera_ecosystem.git
cd optic_x_camera_ecosystem
```
